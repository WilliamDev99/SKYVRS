          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                {[
                  { key: "mobile", label: "MOBILE", src: selectedWallpaper.mobile },
                  { key: "tablet", label: "TABLET", src: selectedWallpaper.tablet },
                  { key: "desktop", label: "DESKTOP", src: selectedWallpaper.desktop },
                ].map(({ key, label, src }) => (
                  <a
                    key={key}
                    href={src}
                  ...
                  >
                    <div className="w-12 h-16 rounded-lg overflow-hidden bg-black flex-shrink-0 border border-white/20">
                      <img src={src} className="w-full h-full object-cover" alt={label} />
                    </div>
                    <span className="text-white font-bold tracking-[0.15em] absolute right-16 text-sm" style={{ fontFamily: "'Orbitron', sans-serif" }}>{label}</span>
